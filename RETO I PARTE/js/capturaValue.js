...
let ubicacionImagenes1= ['img/1.png', 'img/2.png', 'img/3.png', 'img/4.png','img/5.png','img/6.png'];

function Intento(ubicacionImagenes1){
    let arrayInput =[];

    ubicacionImagenes1.array.forEach(element => {
        arrayInput.push();
    });
}
